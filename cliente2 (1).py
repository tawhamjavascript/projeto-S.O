...
while True:    # Menu de escolhas do usuário
    ...
    try:
        comando = lista_comandos.get(cmd_usr[0].lower())  # Ler o comando dado pelo usuário
        ...
        if comando == "CREATE":
            ...
            if tamanho_comando > 1:
                ...
                if lista_de_erros.get(msg_status) is None:     
                    ...
                    print(lista_de_erros.get(msg_status)) # Se acontecer algum erro exibe a mensagem de erro na tela
